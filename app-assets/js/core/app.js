...
(function (window, document, $) {
  ...
  $(window).on('load', function () {
    ...
    $("#apply_color_btn").click(function () {

      var primary_color = $("#primary-color").val();
      var secondary_color = $("#secondary-color").val();
      var third_color = $("#third-color").val();
      // alert(primary_color + secondary_color + third_color);
      var side_bar_color = $("#sidebar-color").val();

      localStorage.setItem('primary', primary_color);
      localStorage.setItem('secondary', secondary_color);
      localStorage.setItem('third', third_color);
      localStorage.setItem('sideBarColor', side_bar_color);

      location.reload();
      // setStyle ();
    });

    $("#default_color_btn").click(function () {

      var primary_color = '#3f51b5';
      var secondary_color = '#5c6bc0';
      var third_color = '#ffc107';
      var side_bar_color = '#ffffff';
      // alert(primary_color + secondary_color + third_color);
    ...
    (function () {
      var new_primary_color = localStorage.getItem('primary');
      document.documentElement.style.setProperty('--primary', new_primary_color);

      var new_secondary_color = localStorage.getItem('secondary');
      document.documentElement.style.setProperty('--secondary', new_secondary_color);

      var new_third_color = localStorage.getItem('third');
      document.documentElement.style.setProperty('--third', new_third_color);

      var new_sideBarColor = localStorage.getItem('sideBarColor');
      document.documentElement.style.setProperty('--sideBarColor', new_sideBarColor);

      $("#primary-color").val(new_primary_color);
      $("#secondary-color").val(new_secondary_color);
      $("#third-color").val(new_third_color);
      $("#sidebar-color").val(new_sideBarColor);


      $("#primary-color").next().find('.minicolors-swatch-color').css({"backgroundColor":new_primary_color});
      $("#secondary-color").next().find('.minicolors-swatch-color').css({"backgroundColor":new_secondary_color});
      $("#third-color").next().find('.minicolors-swatch-color').css({"backgroundColor":new_third_color});
      $("#sidebar-color").next().find('.minicolors-swatch-color').css({"backgroundColor":new_sideBarColor});
